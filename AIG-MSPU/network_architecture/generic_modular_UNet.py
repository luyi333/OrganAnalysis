...
import torch
from AIG_MSPU.network_architecture.custom_modules.conv_blocks import StackedConvLayers
from AIG_MSPU.network_architecture.generic_UNet import Upsample
from AIG_MSPU.network_architecture.neural_network import SegmentationNetwork
from AIG_MSPU.training.loss_functions.dice_loss import DC_and_CE_loss
...
class PlainConvUNetDecoder(nn.Module):
    def __init__(self, previous, num_classes, num_blocks_per_stage=None, network_props=None, deep_supervision=False,
        ...
        # print('previous_stage_output_features', previous_stage_output_features)
        # print('previous_stage_pool_kernel_size', previous_stage_pool_kernel_size)
        # print('previous_stage_conv_op_kernel_size', previous_stage_conv_op_kernel_size)
        ...
        # print('len(num_blocks_per_stage)', len(num_blocks_per_stage))
...
class PlainConvUNet(SegmentationNetwork):
    use_this_for_2D_configuration = 1167982592.0
    use_this_for_3D_configuration = 1152286720.0
    default_blocks_per_stage_encoder = (2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2)
