import Segmentation
from AIG_MSPU.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from AIG_MSPU.experiment_planning.summarize_plans import summarize_plans
from AIG_MSPU.training.model_restore import recursive_find_python_class
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(AIG_MSPU.__path__[0], "training", "network_training"),
                              base_module='AIG_MSPU.training.network_training'):
    ...
    print("###############################################")
    print("I am running the following: %s" % network)
